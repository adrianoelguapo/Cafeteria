...
\justify
Los posibles casos de uso de la aplicación son los siguientes:
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}\hline
        ...
        % Añadir artista&El usuario introduce la información pertinente y se añade el artista a la base de datos de la aplicación.\\ \hline
